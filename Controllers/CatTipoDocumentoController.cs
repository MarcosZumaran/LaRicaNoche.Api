...
{
    private readonly ICatTipoDocumentoService _service;

    public CatTipoDocumentoController(ICatTipoDocumentoService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CatTipoDocumentoCreateDto dto)
    {
    ...
    [HttpPut("{codigo}")]
    public async Task<IActionResult> Update(string codigo, CatTipoDocumentoUpdateDto dto)
    {
